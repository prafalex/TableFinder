...
export const addScore: (payload: ScorePayload) => PayloadAction<ScorePayload> =
  scoreSlice.actions.addScore;

export const removeScore: (
  payload: ScorePayload
) => PayloadAction<ScorePayload> = scoreSlice.actions.removeScore;
